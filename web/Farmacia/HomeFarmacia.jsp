<%-- 
    Document   : HomeFarmacia
    Created on : Nov 18, 2019, 12:38:20 PM
    Author     : sergio
--%>
...
<html>
    ...
    <body>
        ...
        <ul class="nav nav-pills nav-fill" role="tablist" id="myTab">
            <li class="nav-item">
                <a class="nav-link active <c:if test="${requestScope['Ganancias'] == true}"> active</c:if>"  id="contact-tab" data-toggle="tab" href="#Periodos" role="tab" aria-controls="Periodos" aria-selected="true">Venta</a>
            </li>
            <li class="nav-item">
                <a class="nav-link  <c:if test="${requestScope['Ganancias'] == true}"> active</c:if>"  id="contact-tab" data-toggle="tab" href="#Contrataciones" role="tab" aria-controls="Contrataciones" aria-selected="false">Compra</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <c:if test="${requestScope['Ganancias'] == true}"> active</c:if>"  id="contact-tab" data-toggle="tab" href="#Salarios" role="tab" aria-controls="Periodos" aria-selected="false">Cierre De Inventario</a>
            </li>
            <li class="nav-item">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active <c:if test="${requestScope['comentarios'] == true}">show active</c:if>" id="Periodos" role="tabpanel" aria-labelledby="Periodos-tab"><%@include file="Venta.jsp"%></div>
            <div class="tab-pane fade <c:if test="${requestScope['Suscripciones'] == true}">show active</c:if>" id="Contrataciones" role="tabpanel" aria-labelledby="Contrataciones-tab"><%@include file="Compra.jsp"%></div>
