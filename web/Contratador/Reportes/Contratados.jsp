...
<div class="p-3 mb-2 bg-dark text-white" style="text-align: right">
    ...
    <form action="/Hospital/FiltracionEmpleados" method="post">
        ...
        <input class="btn btn-light" type="submit" value="Filtrar" name="FiltrarCon">
        &nbsp;<input class="btn btn-light" type="submit" value="Resetear" name="ResetearCon">
    </form>
</div>
...
<%    ArrayList<String[]> comen;
    if (request.getAttribute("EmpleadosAMostrarC") != null) {
        comen = (ArrayList) request.getAttribute("EmpleadosAMostrarC");
    } else {
        ControladorReportes com = new ControladorReportes();
        comen = com.obtenerContratados(null, null, null);
    }
%>
...
<form action="/Hospital/Reportes" method="post">
    <%session.setAttribute("Array", comen);%>
