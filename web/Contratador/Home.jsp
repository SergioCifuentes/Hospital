...
<html>
    ...
    <body>
        ...
        <ul class="nav nav-pills nav-fill" role="tablist" id="myTab">
            ...
            <div class="tab-pane fade <c:if test="${requestScope['Ganancias'] == true}">show active</c:if>" id="Reportes" role="tabpanel" aria-labelledby="Reportes-tab"><%@include file="Reportes/Contratados.jsp"%></div>
        </div>
